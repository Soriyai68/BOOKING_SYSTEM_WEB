export default {
  ...
  backup: {
    ...
    backupScheduleDescription: "Configure automated backup schedules using cron expressions",
    ...
    backupSystemRequires: "The backup system requires mongodump and mongorestore commands to function",
    messages: {
      enterBackupDescription: "Enter backup description...",
      restoreWarningMessage: "This operation will restore the database from the selected backup.",
      chooseBackupToRestore: "Choose a backup to restore",
      yes: "Yes",
      no: "No",
      dropDatabaseHelp: "If enabled, the existing database will be completely replaced.",
      ...
      confirmDeleteBackup: "Are you sure you want to delete the backup \"{name}\"? This action cannot be undone.",
      confirmRestoreDatabase: "This will restore the database from the selected backup. This action cannot be undone. Continue?",
      cronExpressionRequired: "Cron expression is required",
