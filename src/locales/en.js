export default {
    ...
    seats: {
        ...
        deleteSelectedConfirm: "Are you sure you want to delete  {count} selected seat?",
        forceDeleteTitle: "Permanent Delete Seats",
        forceDeleteSelectedConfirm: "<strong>⚠️ Warning:</strong> Are you sure you want to <strong>permanently delete</strong> {count} selected seats?<br/><br/>This action <strong>cannot be undone</strong>!",
    ...
    showtimes: {
        ...
        deleteSelectedConfirm: "Are you sure you want to delete {count} selected showtimes?",
        forceDeleteTitle: "Force Delete Showtimes",
        forceDeleteSelectedConfirm: "<strong>⚠️ Warning:</strong> Are you sure you want to <strong>permanently delete</strong> {count} selected showtimes?<br/><br/>This action <strong>cannot be undone</strong>!",
