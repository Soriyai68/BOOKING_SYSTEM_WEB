...
export const useAuthStore = defineStore('auth', () => {
  ...
  const token = ref(localStorage.getItem(import.meta.env.VITE_AUTH_TOKEN_KEY || 'cinema_auth_token') || null)
  const refreshToken = ref(localStorage.getItem(import.meta.env.VITE_AUTH_REFRESH_TOKEN_KEY || 'cinema_refresh_token') || null)
