  ...
  <div class="create-theater">
    ...
    <el-card>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="140px">
        ...
        <el-form-item :label="$t('theaters.totalCapacity')" prop="total_capacity">
        ...
        <el-form-item>
          <el-button type="primary" :loading="loading" @click="handleSubmit">{{ $t('actions.submit') }}</el-button>
...
const featureOptions = ['parking','food_court','disabled_access','air_conditioning','wifi','3d_capable','imax','vip_lounge','arcade']
...
const rules = {
  ...
  city: [{ required: true, message: t('validation.required'), trigger: 'blur' }],
  province: [{ required: true, message: t('validation.required'), trigger: 'blur' }]
}
...
const resetForm = () => {
  ...
  Object.assign(form, { name: '', address: '', city: '', province: '', status: 'active', total_capacity: 0, features: [], notes: '' })
}
