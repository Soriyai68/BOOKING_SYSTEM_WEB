  ...
  <div class="edit-theater">
    ...
    <el-card v-loading="pageLoading">
      ...
      <el-form v-else ref="formRef" :model="form" :rules="rules" label-width="140px">
        ...
        <el-form-item>
          <el-button type="primary" :loading="loading" @click="handleSubmit">{{ $t('theaters.updateTheater') }}</el-button>
...
const form = reactive({
  name: '', address: '', city: '', province: '', status: 'active', total_capacity: 0, features: [], notes: ''
})
